...
## Pearson correlation across replicates
...
Save rlog data for subsequent analyses

```{r}
fwrite(rlog.df, paste0(base.results.dir, "deseq2_smoops/deseq2_results_tables/smoops_deseq2.rlog.tsv.gz"), 
       sep = "\t", row.names = TRUE)
```
...
fish.mean_rlog.df <- mean_rlog.df %>%
  dplyr::select(id, mean_control_naive, mean_oops_naive, mean_semi_naive) %>%
